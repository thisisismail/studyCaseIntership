...
const DropDownMenu = () => {
  ...
  return (
    ...
    >
      ...
      <MenuList className="bg-gradient-to-r from-cyan-500 to-blue-500 md:hidden border-0 -mt-2 rounded-none w-full drop-shadow-xl relative z-40">
        {menu}
        <Menu
          placement="bottom-end"
          animate={{
        ...
        >
          ...
          <MenuList className="md:hidden bg-gradient-to-r from-cyan-500 to-blue-500 border-0 rounded-none  drop-shadow-xl relative z-40 w-full">
